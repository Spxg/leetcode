...
mod tests {
    ...
    pub fn run<S: Solution>() {
        ...
        for (preorder, postorder) in test_cases {
            ...
            let pre_order_result =
                test_utilities::iter_tree_pre_order(result.clone()).collect::<Vec<_>>();
            let post_order_result =
                test_utilities::iter_tree_post_order(result).collect::<Vec<_>>();
